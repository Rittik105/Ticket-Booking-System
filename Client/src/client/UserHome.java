...
public class UserHome implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        try{
            Main.dataOutputStream.writeUTF("home#"+Controller.username);
            Parent root = FXMLLoader.load(getClass().getResource("userpurchases.fxml"));
    ...
    public void onActionsearch (ActionEvent event) throws IOException {
        if (datePicker.getValue()!=null&&startCombo.getValue()!=null&&destiCombo.getValue()!=null) {
            ...
            destination = destiCombo.getValue();
            date = datePicker.getValue().toString();
            userName = loggedIn.getText();

            String str = "search#"+start+"#"+destination+"#";
